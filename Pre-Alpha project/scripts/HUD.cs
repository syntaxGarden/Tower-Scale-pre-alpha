...
public partial class HUD : Control
{
	...
	*/
	...
	public void DebugText(string text) { 
		((Label)GetNode("debug_text")).Text = text;
	}
	...
	private void OnFOVChanged(float value) {
		...
		val_text.Text = value.ToString();
		FOVChanged?.Invoke(value); //The ? is needed because otherwise you get a System.NullReferenceException error
	} 
